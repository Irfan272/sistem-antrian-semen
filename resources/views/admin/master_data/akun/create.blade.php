                               ...
                               @csrf
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{ old('username') }}" class="@error('username') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="username" required="required" />
                                        @error('username')
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" value="{{ old('nama_lengkap') }}" class="@error('nama_lengkap') parsley-error @enderror form-control" data-validate-length-range="6" data-validate-words="2" name="nama_lengkap" required="required" />
                                        @error('nama_lengkap')
                                        <ul class="parsley-errors-list filled">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>   
